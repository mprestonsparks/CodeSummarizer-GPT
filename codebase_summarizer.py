...
#         self.directory = Path(directory).resolve().parent
#         self.summary = []
...
#         ignore_path = self.directory / "gpt4-helper" / ".ignore"
...
#                 lines.extend(self.print_tree(tree[key], prefix=prefix+"    "))
#         return lines
...
class CodebaseSummarizer:
    ...
    def write_summary(self):
        tree = self.create_tree()
        lines = self.print_tree(tree)
        with open("codebase-summary.txt", "w") as f:
